...
%        the input argument must be given in a structure with parameter "value". Ricardo
...
%      function named CALLBACK in GUI_CHOOSE_INPUT.M with the given input arguments.
%
...
% Last Modified by GUIDE v2.5 08-Oct-2004 13:01:53
...
set(handles.input, 'String', input.value);
...
output.value=get(handles.input, 'String');
...
in=gui_interpret_input(output.value);
